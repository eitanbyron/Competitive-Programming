...
int main() {
    ...
    vector<long long> sum_a(3);
    vector<long long> sum_b(3);
    ...
    sum0 = (sum_a[0]*sum_b[1]) + (sum_a[1]*sum_b[0]) + (sum_a[2]*sum_b[2]);
    sum1 = (sum_a[0]*sum_b[2]) + (sum_a[1]*sum_b[1]) + (sum_a[2]*sum_b[0]);
    sum2 = (sum_a[0]*sum_b[0]) + (sum_a[1]*sum_b[2]) + (sum_a[2]*sum_b[1]);
